...
//we use a typedef instead of '#include<stdbool.h>' as "bool" is not a key-word to the compiler, so including it when we use it as a return type gives unrecognised return type errors
